...
public class ActivityOne extends Activity {
	...
	// Используйте эти ключи когда вы сохраняете состояние между реконфигурациями
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		launchActivityTwoButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO:
				// Запустите Activity Two
				// Подсказка: используйте метод класса Context с именем startActivity()

				// Создайте intent обозначающий, какой  Activity вы хотите запустить
				Intent intent = null;

				// Запустите Activity используя интент
